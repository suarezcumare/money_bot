...
Telegram::Bot::Client.run(token) do |bot|
  bot.listen do |message|
    full_name = message.chat.first_name && message.chat.last_name ? [message.chat.first_name, message.chat.last_name].join(" ") : message.chat.username
    case message.text
    when '/start'
      bot.api.send_message(chat_id: message.chat.id, text: "Hola #{full_name} \n El Bot para saber el precio del dolar, Chile: /moneycl Vzla: /moneyvzla, la tasa de cambios Cl a Ve: /clave y Ve a Cl: /veacl")
    when '/moneycl'
